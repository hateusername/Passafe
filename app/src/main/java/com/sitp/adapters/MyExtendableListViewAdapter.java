...
public class MyExtendableListViewAdapter extends BaseExpandableListAdapter {
    ...
    //用于在子选项显示时平移对齐
    int item_translation=0;
    public String[] groupString = {};
    public String[][] childString = {};

    public MyExtendableListViewAdapter(String[] group,String[][] child,int translation) {
        groupString=group;
        childString=child;
        item_translation=translation;
    };
    ...
    public Object getChild(int grupPosition,int childPosition){
        return childString[grupPosition][childPosition];
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String string="";
        for(int i=0;i<item_translation;i++)
            string+=" ";
        childViewHolder.tvTitle.setText(string+childString[groupPosition][childPosition]);
        return convertView;
    }
